...
function Navigation() {
   ...
   return (
      <header className="w-full fixed bg-transparent z-10">
         <nav className="w-10/12 md:w-8/12 max-w-screen-lg mx-auto flex justify-between pt-12 md:pt-24">
            <Link to="/">
            ...
            <Link to={aboutPage ? "/" : "/about"}>
               <div className="group flex">
                  <p className="text-xl md:text-2xl text-primary transition duration-300 hover:border-b-2 hover:border-primary hover:ml-2  pt-3 md:pt-2 align-baseline">
