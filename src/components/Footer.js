            ...
            <TransitionInview>
                <footer className="w-full max-w-screen-xxl mx-auto pb-10 md:pb-24 pt-10 md:pt-10 lg:pt-32">
                    <ul className="w-10/12 md:w-8/12 max-w-screen-xl mx-auto flex flex-col md:flex-row font-bold text-center text-red-600 justify-between xlg:ml-32">
                        ...
                        >
                            <li className="xlg:inline-block text-2xl sm:text-lg md:text-2xl xl:text-4xl hover:text-red-800 ease-in-out mb-3">
                        ...
                        >
                            <li className="xlg:inline-block text-xl sm:text-lg md:text-2xl xl:text-4xl hover:text-red-800 ease-in-out mb-3">
                                Instagram
                            </li>
                        </a>
                        <a
