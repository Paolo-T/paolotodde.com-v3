    ...
    return (
        <>
            <div className={`grid grid-cols-${gridCol} gap-${gap}`}>
                ...
                <TransitionInview>
                    <Link to="/shuush">
                        <div className="group w-full cursor-pointer relative transition duration-500 transform hover:scale-98 text-center mt-2 md:my-10">
                            <div
                                className="text-yellow-500 absolute top-1 z-50 opacity-0 group-hover:opacity-100 transition duration-500"
                                style={{
                                    top: "50%",
                ...
                <TransitionInview>
                    <Link to="/classica" className="w-full h-full">
                        <div className="group w-full cursor-pointer relative transition duration-500 transform hover:scale-98 text-center mb-2 md:mb-10">
                            <div
