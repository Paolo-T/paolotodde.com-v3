...
function classica() {
    const data = useStaticQuery(graphql`
        query {
            ...
            spaceDigestImg_2: file(
                relativePath: { eq: "spaceDigest/spaceDigest_0.png" }
            ) {
                id
                childImageSharp {
                    fluid(maxWidth: 2880) {
            ...
            spaceDigestImg_3: file(
                relativePath: { eq: "spaceDigest/spaceDigest_1.png" }
            ) {
                id
                childImageSharp {
                    fluid(maxWidth: 2880) {
            ...
            spaceDigestImg_4: file(
                relativePath: { eq: "spaceDigest/spaceDigest_2.png" }
            ) {
                id
                childImageSharp {
                    fluid(maxWidth: 2880) {
            ...
            spaceDigestImg_5: file(
                relativePath: { eq: "spaceDigest/spaceDigest_3.png" }
            ) {
                id
                childImageSharp {
                    fluid(maxWidth: 2880) {
                ...
                <TransitionPageIn>
                    ...
                    <div className="w-full bg-white pt-10 pb-20 md:pt-28 md:pb-48">
                        <section className="w-11/12 md:w-8/12 mx-auto text-black md:flex mt-10 md:mt-12 mb-0">
                            ...
                            <div className="w-12/12 md:w-7/12 mt-16 md:mt-0 md:pr-24">
                                ...
                                <p>
                                    ...
                                    is an informative web resource for the
                        ...
                        <section className="w-11/12 md:w-8/12 mx-auto text-black md:flex mt-10 md:mt-12 mb-0">
                            ...
                            <div className="w-12/12 md:w-7/12 mt-16 md:mt-0 md:pr-24">
                                ...
                                <p>
                                    ...
                                    design is simple and accessible. The UI is
                                    designed to facilitate the displaying of
                                    data information
                                </p>
                            </div>
                        </section>
                        <section className="w-11/12 md:w-8/12 mx-auto text-black md:flex mt-10 md:mt-12 mb-0">
                            ...
                            <div className="w-12/12 md:w-7/12 mt-16 md:mt-0 md:pr-24">
                                ...
                                <p>
                                    ...
                                    is developed using the Jam stack. Gatsby.js,
                                    React.js and deployed on Netlify. It
                                    consumes data from the Nasa and SpaceX open
                                    APIS
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="w-11/12 md:w-8/12 mx-auto flex space-x-16 text-black mt-10 md:mt-32 mb-0">
                            <Img
                                fluid={
                                    data.spaceDigestImg_2.childImageSharp.fluid
                                }
                            ...
                            <Img
                                fluid={
                                    data.spaceDigestImg_3.childImageSharp.fluid
                                }
                                className="flex-1 shadow-lg"
                                loading="eager"
                                alt="App screen"
                        ...
                        <section className="w-11/12 md:w-8/12 mx-auto flex space-x-16 text-black mt-10 md:mt-32 mb-0">
                            <Img
                                fluid={
                                    data.spaceDigestImg_4.childImageSharp.fluid
                                }
                                className="flex-1 shadow-lg"
                                loading="eager"
                                alt="App screen"
                            ...
                            <Img
                                fluid={
                                    data.spaceDigestImg_5.childImageSharp.fluid
                                }
                                className="flex-1 shadow-lg"
                                loading="eager"
                                alt="App screen"
