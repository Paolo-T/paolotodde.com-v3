                  ...
                  <section className="w-11/12 md:w-8/12 mx-auto text-black md:flex mt-10 md:mt-12 mb-0">
                     ...
                     <div className="w-12/12 md:w-7/12 md:mt-0 md:pr-24">
                        ...
                        <p>
                           ...
                           UI is designed to facilitate the displaying of data information
                        </p>
                     </div>
                  </section>
                  <section className="w-11/12 md:w-8/12 mx-auto text-black md:flex mt-10 md:mt-12 mb-0">
                     ...
                     <div className="w-12/12 md:w-7/12 md:mt-0 md:pr-24">
                        ...
                        <p>
                           ...
                           Gatsby.js, React.js and deployed on Netlify. It consumes data from the Nasa and SpaceX open
                           APIS
                        </p>
                     </div>
                  </section>
